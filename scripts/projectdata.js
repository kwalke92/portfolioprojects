...
rh.consts('DEFAULT_TOPIC', encodeURI("#The_Sims_4_CC_How-To_and_Troubleshooting/The_Sims_4_CC_How-To_and_Troubleshooting.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', 'A0A940B6-B4F6-4C83-9E4F-E39E8014C8E1' || 'preview');
